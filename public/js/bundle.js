...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-74.248882, 40.736703],
    // zoom: 4,
    // interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'Success') {
              (0, _alerts.showAlert)('success', "".concat(type.charAt(0).toUpperCase() + type.slice(1), " Updated Successfuly"));
            }
...
var stripe = Stripe('pk_test_51GzSODEDr9DWjj2gPMLSz1OtjigNlN7XcXOwKoEu0BtOghzQVyZSXlYneJen6Rhy1pv0RhT9WWyrSbxOxQDNE0cF00C0c2cRig');
